...
--
-- Test users:
--   digit@test.local / local-fixture-not-a-secret     (UUID: 11111111-...) — admin, prompt author
--   other@test.local / local-fixture-not-a-secret     (UUID: 22222222-...) — second user
--   sophie@dyad.berlin / local-fixture-not-a-secret     (UUID: 33333333-...) — Playwright tester
--   tom@dyad.berlin / local-fixture-not-a-secret        (UUID: 44444444-...) — Playwright tester
--
...
DO $$
DECLARE
  v_encrypted_pw_dev TEXT := crypt('local-fixture-not-a-secret', gen_salt('bf'));
  v_encrypted_pw_test TEXT := crypt('local-fixture-not-a-secret', gen_salt('bf'));
