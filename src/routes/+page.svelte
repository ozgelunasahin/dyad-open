<script lang="ts">
	...
	// Clicking a map pin opens the nearest conversation in the left detail pane.
	function handlePinSelect(prompts: PromptSummary[]) {
		if (prompts.length > 0) selected = prompts[0];
	}
