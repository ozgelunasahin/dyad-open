							...
							<a href="/meetings/{item.meeting!.id}" class="conv-item past">
								...
								<div class="meeting-inline">
									...
									{#if item.meeting!.general_area}
										<span class="meeting-inline-area">{item.meeting!.general_area}</span>
									{/if}
									{#if item.meeting!.state === 'cancelled_early' || item.meeting!.state === 'cancelled_late'}
										<span class="meeting-inline-status cancelled">{copy.profile.meetingCancelledBy(item.meeting!.partner_username)}</span>
									{/if}
								</div>
							</a>
						{/each}
