...
/**
 * Extract plain text from TipTap JSONContent (no HTML).
 * Useful for summaries or truncated previews.
 *
 * @param content - TipTap document JSON
 * @param maxLength - Optional max length (truncates with ellipsis)
